...
rcon = [[0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36], [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00],
...
if __name__ == '__main__':
    ...
    for byte in data:
        ...
        if len(temp) == 16:
            ...
            print(crypted_data)
            del temp[:]
    out_path = os.path.join(os.path.dirname(input_path) ,'1'+os.path.basename(input_path))
